...
export default function LessonPlayer({
  ...
  const showModuleQuizButton = completed && allModuleLessonsDone && moduleQuizId && !moduleQuizPassed
  const showQuizButton = completed && allProgramLessonsDone && programQuizId
  // Only show Next Module if there's no pending module quiz gate
  const showNextLesson = completed && nextLesson
  const showNextModule = completed && !nextLesson && nextModuleFirstLesson && !showModuleQuizButton
    ...
    <div className="flex flex-col flex-1">
      ...
      <div className="flex-1 max-w-3xl w-full mx-auto px-6 py-8">
        ...
        <div className="flex flex-wrap items-center gap-3 pt-5" style={{ borderTop: '1px solid #EBEBEB' }}>
          ...
          {showModuleQuizButton && (
            <Link href={`/programs/${slug}/${moduleId}/quiz`}
          ...
          {showQuizButton && (
            <StarButton href={`/programs/${slug}/quiz`}>
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                  d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
              </svg>
